...
When you run one of the tasks included in this task folder, it will save all task output data files in a sub-folder inside the **{{< var tasks >}} Folder**
...
1.  Open **PsychExp** from the {{< var tasks >}} Folder or the shortcut from your Desktop.
...
4.  To access the task output data files (the .dat, .raw, .dbg, and .log files), open the **{{< var tasks >}} Folder** and then open the task subfolder SimpleStop or NBack
...
6.  Email {{< var email >}} if you would like to receive a list of previously sent POND IDs to confirm which files to exclude
...
5.  Send the zipped folder by email to {{< var email >}} using the subject line: yourpondsitename Stop & NBack POND Data quarter year (e.g., SickKids Stop & NBack POND Data Q1 2026) and include a note in the body of the email if there are notes in the task .csv file to resolve
