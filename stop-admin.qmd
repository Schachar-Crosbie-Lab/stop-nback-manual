...
To launch the task from the Desktop, instead of having to navigate to the {{< var tasks >}} Folder each time you run a participant, create a PsychExp shortcut on the Desktop from the Task Folder (steps available in [Technical Manual](technical-manual.qmd))
:::
