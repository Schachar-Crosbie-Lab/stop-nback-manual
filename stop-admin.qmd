...
Ensure installation steps outlined in [Technical and Interpretive Manual](technical-manual.qmd) are completed prior to administration

## **Simple Stop Task**

**Administration time:** approximately 10 minutes (2 minutes per block).

What we are trying to calculate is what is known as Stop Signal Reaction Time (SSRT) which reflects the latency of the stopping process. SSRT cannot be measured directly because there is no overt response that latency of which can be measured when you stop doing something.
...
To launch the Stop Task from the Desktop, instead of having to enter the SchacharLabTaskFolder_v6.3.1 Folder each time you run a participant, create a PsychExp shortcut on the Desktop from the Task Folder (steps available in [Technical Manual](technical-manual.qmd))
:::
...
-   **Laptop** with PsychExp setup (see [Technical and Interpretive Manual](technical-manual.qmd))
-   **Laptop Charger**
-   **Game Controller**
-   **Quiet Room** 
...
4.  Double click [**PsychExp** @fig-pe]
...
-   **PCR:** percent correct responses – how often they are correctly pressing X and O

-   Should be **above 66%**

-   **PSI:** percent stop inhibition – how often they are inhibiting when they hear a beep

-   should be in between **12.5% to 87.5%**

-   **SSRT:** stop signal reaction time – latency of the stopping process

-   **MCRT:** mean reaction time – how fast they are responding when they see an X or O
...
| There are **0 go trials with responses, or 0 stop trials** | **No responses were detected**. | Participant **did not press** the X nor the O button or they may be pressing the **wrong buttons** on the controller. | Review buttons with participant and remind participant to press X or O buttons when prompted. |
