...
This software comes with absolutely no warranty. Your feedback on these installation instructions is appreciated. Please send your comments or questions to {{< var email >}}.

## Download the {{< var tasks >}} Folder
...
1.  Download the [**Zipped {{< var tasks >}}**]{.fig-hover data-fig="fig-zip"} that was emailed to you on the research measures laptop’s desktop
2.  Right click on the folder and select **Extract All**
3.  Remove the [**Zipped {{< var tasks >}}**]{.fig-hover data-fig="fig-zip"}
4.  You can place the [**Unzipped {{< var tasks >}}**]{.fig-hover data-fig="fig-unzip"} Folder anywhere on the laptop that is convenient
...
5.  Create a shortcut of PsychExp to run the tasks from your desktop without needing to open the folder each time:
    -   Right-click the [**PsychExp Icon**]{.fig-hover data-fig="fig-pe"} > Show More Options > Create a Shortcut
...
::: {.column-margin}
![Zipped Folder Icon](img/gen02.png){#fig-zip}

![Unzipped Folder Icon](img/gen01.png){#fig-unzip}
...
Two files within the {{< var tasks >}} need to be verified by you to ensure the task will run correctly:

-   [stopsignal.exp]{.fig-hover data-fig="fig-stexp"}

-   [nback.exp]{.fig-hover data-fig="fig-nbexp"}
...
::: {.column-margin}
![Stop Signal .exp file](img/st14.png){#fig-stexp}

![NBack .exp file](img/nb04.png){#fig-nbexp}
:::
...
3.  On the Presentation **Main** tab, ensure the Logfile Directory is set to the {{< var tasks >}} Folder (for convenience you can copy that entire directory path as you will be using it a few more times).
4.  On the **Scenarios** tab, again ensure the Logfile Directory is set to the {{< var tasks >}} Folder.
5.  On the **Scenarios** tab, the Stimulus Directory should also be set to the {{< var tasks >}} Folder (the Scenarios box should have the stopsignal.sce file from the task file directory – this file is created each time you run the experiment with the parameters you choose).
...
![Logitech Gamepad F310](img/st03.jpg){width="250"}
:::
...
5.  On the **Scenarios** tab, the Stimulus Directory should also be set to the {{< var tasks >}} Folder (the Scenarios box should have the nback.sce file from the task file directory – this file is created each time you run the experiment with the parameters you choose).
