...
1.  Download the [**Zipped SchacharLabTaskFolder_v6.3.1**]{.fig-hover data-fig="fig-zip"} that was emailed to you on the research measures laptop’s desktop
2.  Right click on the folder and select **Extract All**
3.  Remove the [**Zipped SchacharLabTaskFolder_v6.3.1**]{.fig-hover data-fig="fig-zip"}
4.  You can place the [**Unzipped SchacharLabTaskFolder_v6.3.1**]{.fig-hover data-fig="fig-unzip"} Folder anywhere on the laptop that is convenient
